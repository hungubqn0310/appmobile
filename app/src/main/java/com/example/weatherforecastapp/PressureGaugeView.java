...
public class PressureGaugeView extends View {
    ...
    private float pressure = 1009f; // Giá trị áp suất hiện tại
    ...
    private void drawPressureText(Canvas canvas) {
        ...
        String pressureText = showPlaceholder ? "--" : String.format("%.3f", pressure);
    ...
    // Thêm phương thức để chuyển đổi giữa placeholder và giá trị thực
    ...
    // Phương thức để cập nhật giá trị áp suất
